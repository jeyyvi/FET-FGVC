...
# import numpy as np
# # import matplotlib  # Keep these commented!
# # matplotlib.use("agg")
...
# ============================================================================
# GOOGLE DRIVE CHECKPOINT FUNCTIONS - ADD THIS SECTION
# ============================================================================
...
def main():
    ...
    if not args.vis_mode:
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            # ============================================================
            # SAVE CHECKPOINT TO GOOGLE DRIVE - ADD THESE LINES
            # ============================================================
            ...
            if best_val is None or val_acc > best_val:
                ...
                logging.info("Saved best model.")
                # ============================================================
                # SAVE BEST CHECKPOINT TO GOOGLE DRIVE - ADD THIS LINE
                # ============================================================
